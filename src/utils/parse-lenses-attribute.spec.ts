...
describe('parseLensesAttribute', () => {
  ...
  describe('mixed separators', () => {
    it('should handle both spaces and commas together', () => {
      const result = parseLensesAttribute('reverse uppercase, lowercase jsx-demo');

      expect(result).toEqual(['reverse', 'uppercase', 'lowercase', 'jsx-demo']);
    });
    ...
    it('should handle complex mixed separators', () => {
      ...
      expect(result).toEqual(['reverse', 'uppercase', 'lowercase', 'jsx-demo', 'trace-table']);
    });
  ...
  describe('lens name formats', () => {
    ...
    it('should handle mixed format lens names', () => {
      const result = parseLensesAttribute('simple-lens complex_lens_name SimpleLens lens123');

      expect(result).toEqual(['simple-lens', 'complex_lens_name', 'SimpleLens', 'lens123']);
    });
  ...
  describe('real-world scenarios', () => {
    it('should handle typical pipeline definitions', () => {
      const scenarios = [
        { input: 'reverse uppercase', expected: ['reverse', 'uppercase'] },
        { input: 'reverse, uppercase, lowercase', expected: ['reverse', 'uppercase', 'lowercase'] },
        { input: 'jsx-demo', expected: ['jsx-demo'] },
        { input: 'format trace-table jsx-demo', expected: ['format', 'trace-table', 'jsx-demo'] },
        {
          input: 'reverse,uppercase,jsx-demo,trace-table',
          expected: ['reverse', 'uppercase', 'jsx-demo', 'trace-table'],
        },
      ];
  ...
  describe('performance characteristics', () => {
    ...
    it('should handle large inputs efficiently', () => {
      const largeInput = Array.from({ length: 1000 }, (_, i) => `lens${i}`).join(' ');
