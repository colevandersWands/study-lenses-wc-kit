...
import type { LensFunction, Snippet } from '../../types.js';

describe('createLensElement', () => {
	const mockLensFunction: LensFunction = (snippet: Snippet) => ({
		snippet: { ...snippet, code: snippet.code.toUpperCase() },
		ui: null,
	});

	const mockViewLensFunction: LensFunction = (snippet: Snippet) => {
	...
	describe('factory function behavior', () => {
		it('should return a class constructor', () => {
			const ElementClass = createLensElement(
				'test-lens',
				mockLensFunction
			);
	...
	describe('lens function integration', () => {
		it('should work with transform lenses', () => {
			const transformLens: LensFunction = (snippet: Snippet) => ({
				snippet: {
					...snippet,
		...
		it('should work with view-generating lenses', () => {
			const viewLens: LensFunction = (snippet: Snippet) => {
				const div = document.createElement('div');
		...
		it('should work with async lens functions', () => {
			const asyncLens: LensFunction = async (snippet: Snippet) => {
	...
	describe('function signature validation', () => {
		...
		it('should work with minimal lens functions', () => {
			const minimalLens: LensFunction = (snippet: Snippet) => ({
				snippet,
				ui: null,
			});
		...
		it('should work with complex lens functions', () => {
			const complexLens: LensFunction = async (
				snippet: Snippet,
				config = {}
			) => {
