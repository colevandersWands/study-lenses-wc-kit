...
<div class="lesson-plan">
	...
	<div class="concept">
		...
		<p>
			Breakpoints pause program execution so you can inspect the current
			state.
		</p>
...
<sl-lens-debug code="puts 'Hello, Ruby!'" lang="ruby"></sl-lens-debug>
```
...
<sl-lens-debug
	code="test();"
	config='{"enabled": true, "lineSpacing": 1}'
></sl-lens-debug>
```
